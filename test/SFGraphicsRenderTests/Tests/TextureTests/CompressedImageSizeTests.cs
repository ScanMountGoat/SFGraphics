...
namespace SFGraphicsRenderTests.Tests.TextureTests
{
    ...
    public class CompressedImageSizeTests
    {
        ...
        [TestMethod]
        public void Dxt1Test()
        {
            Assert.IsTrue(CompressedTexImage2DSucceeded(128, 128, InternalFormat.CompressedRgbaS3tcDxt1Ext));
        }

        [TestMethod]
        public void Dxt3Test()
        {
            Assert.IsTrue(CompressedTexImage2DSucceeded(128, 128, InternalFormat.CompressedRgbaS3tcDxt3Ext));
        }

        [TestMethod]
        public void Dxt5Test()
        {
            Assert.IsTrue(CompressedTexImage2DSucceeded(128, 128, InternalFormat.CompressedRgbaS3tcDxt5Ext));
        }
    }
}
