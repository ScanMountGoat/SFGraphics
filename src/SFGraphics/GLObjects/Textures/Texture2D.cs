...
namespace SFGraphics.GLObjects.Textures
{
    ...
    public class Texture2D : Texture
    {
        ...
        public Texture2D(int width, int height, byte[] baseMipLevel, int mipCount, InternalFormat internalFormat) : base(TextureTarget.Texture2D)
        {
            Width = width;
            Height = height;
        ...
        /// <summary>
        /// Initializes a texture of the specified format and loads all mipmaps from <paramref name="mipmaps"/>.
        /// </summary>
