...
namespace SFGraphics.GLObjects.Textures
{
    ...
    public class Texture2D : Texture
    {
        ...
        public Texture2D(int width, int height, List<byte[]> mipmaps, int imageSize, bool loadMipmaps, InternalFormat pixelInternalFormat) : base(TextureTarget.Texture2D)
        {
            Width = width;
            Height = height;
