...
namespace SFGraphics.GLObjects.Textures
{
    ...
    {
        /// <summary>
        /// Loads compressed 2D image data of the compressed format <paramref name="internalFormat"/> for all the mip levels in <paramref name="mipmaps"/>.
        /// The texture must first be bind to the proper target before calling this method.
        /// </summary>
        /// <param name="textureTarget">The target of the texture or cube face for loading mip maps. Ex: Texture2D or TextureCubeMapPositiveX.</param>
        ...
        public static void LoadCompressedMipMaps(TextureTarget textureTarget, int width, int height, List<byte[]> mipmaps, InternalFormat internalFormat)
        {
