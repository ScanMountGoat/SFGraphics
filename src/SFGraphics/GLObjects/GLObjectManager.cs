...
namespace SFGraphics.GLObjects
{
    ...
    /// <para></para> <para></para>
    /// <see cref="GLObjectManager"/> will maintain reference counts for any class inheriting from <see cref="Textures.Texture"/>,
    /// <see cref="BufferObject"/>, <see cref="Shaders.Shader"/>, or <see cref="Framebuffer"/>.
    /// <para></para>
